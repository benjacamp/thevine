...
register_nav_menus(
	array(
		...
		'secondary-nav' => __( 'Secondary Nav' ) // secondary nav in header
	)
);
...
function joints_secondary_nav() {
    ...
    wp_nav_menu(array(
    	'container' => '',                              // remove nav container
    	'container_class' => 'secondary-nav',   // class of container (should you choose to use it)
    	'menu' => __( 'The Main Menu', 'jointstheme' ),   // nav name
    	'menu_class' => '',      // adding custom nav class
        ...
        'link_after' => '',                             // after each link
        'depth' => 0,                                   // limit the depth of the nav
    	'fallback_cb' => 'secondary_nav_fallback'  // fallback function
	));
} /* end joints footer link */
...
// this is the fallback for footer menu
function secondary_nav_fallback() {
	/* you can put a default here if you like */
}
